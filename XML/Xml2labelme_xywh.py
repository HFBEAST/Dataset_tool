    ...
    for xml_file in os.listdir(xml_folder):
        ...
        if category and visible_bounds:
            try:
                ...
                height = float(visible_bounds.get('@height', 0))
                width = float(visible_bounds.get('@width', 0))
                rectangle_shape = {
        ...
        for kp in keypoints:
            ...
            try:
                ...
                print(f"警告: XML 文件 {xml_file} 中关键点 {label} 有无效的坐标: {ve}")
                continue
...
if __name__ == "__main__":
    ...
    image_folder = r"H:\DATASET\horses\horses_322"
    xml_folder = r"H:\DATASET\horses\horses_322"
    output_folder = r"H:\DATASET\horses\horses_322_labelme"
