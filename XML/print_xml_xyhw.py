...
def draw_annotations(image, annotation):
    ...
    height = int(float(visible_bounds.get('height')))
    width = int(float(visible_bounds.get('width')))
    cv2.rectangle(image, (xmin, ymin), (xmin + width, ymin + height), (0, 255, 0), 2)  # 绿色边框
...
if __name__ == "__main__":
    input_xml_folder = r"H:\0_program\My_learn\mmlab\mmpose\data\animalpose\PASCAL2011_animal_annotation\2333"
    input_img_folder = r"H:\0_program\My_learn\mmlab\mmpose\data\animalpose\PASCAL2011_animal_annotation\2333"
    output_img_folder = r"H:\0_program\My_learn\mmlab\mmpose\data\animalpose\PASCAL2011_animal_annotation\print"
