...
def main():
    input_path = r"E:\PJ\GIO\aiba\dataset\pose\1_net_1600_aiba_3200"
    output_path = r"E:\PJ\GIO\aiba\dataset\pose\0_horse\mmpose\net_1800_aiba_3200"
    ...
    parser.add_argument('--ratios', type=float, nargs=3, default=[0.8, 0.19, 0.01],
                        help='train, val, test 数据集的比例 (默认为 0.75, 0.15, 0.10)')
